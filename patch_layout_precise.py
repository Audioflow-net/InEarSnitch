...
start_idx = 76 # line 77 (0-indexed)
end_idx = 278  # line before 279

new_layout_code = """        self.splitter = QSplitter(Qt.Horizontal)
...
new_lines = lines[:start_idx] + [new_layout_code + "\n"] + lines[end_idx:]
