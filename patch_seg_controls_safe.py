...
# Add QButtonGroup to global imports at the top
code = code.replace("from PyQt5.QtWidgets import (QMainWindow", "from PyQt5.QtWidgets import (QMainWindow, QButtonGroup")
...
print("Segmented controls safely patched.")
