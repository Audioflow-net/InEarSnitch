...
pattern = r'''    def set_text\(self, txt\):
        ...
        self\.lbl\.setHtml\(f'<div style="font-family: Arial; font-size: 64px; color: \{accent\}; font-weight: 900; letter-spacing: 5px; text-transform: uppercase; text-align: center;"><center>\{txt\}</center></div>'\)'''
