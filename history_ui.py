...
class HistoryWidget(QWidget):
    ...
    def update_theme(self):
        ...
        self.btn_chan_r.setStyleSheet(f"QPushButton {{ background-color: {bg_main}; color: {text_sec}; border: 1px solid {border}; border-top-right-radius: 4px; border-bottom-right-radius: 4px; padding: 4px 10px; font-weight: bold; font-size: 11px; }} QPushButton:checked {{ background-color: #ef4444; color: white; border-color: #ef4444; }}")
